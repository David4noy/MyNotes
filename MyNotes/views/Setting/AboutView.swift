...
struct AboutView: View {
    ...
    - Add a single location to each note to remember where it matters.
    - Customize your notes with beautiful colors to quickly identify what’s important.
    ...
    - הוספת תמונות להעשיר את ההערות שלכם.
    - הוספת מיקום יחיד לכל הערה כדי לזכור היכן זה חשוב.
    - התאמה אישית של ההערות עם צבעים יפים לזיהוי מהיר של מה שחשוב.
    - סינכרון וגיבוי חלק עם iCloud, כך שהנתונים שלכם בטוחים ונגישים בכל המכשירים.
    - שיתוף הערות בצורה מאובטחת או ייצוא כקובצי PDF לשיתוף וגיבוי נוח.
    - ממשק נקי ואינטואיטיבי שמאפשר עבודה חלקה.

    הנתונים שלכם נשמרים בבטחה עם סינכרון iCloud, אך מומלץ לגבות את ההערות שלכם באופן שוטף.
